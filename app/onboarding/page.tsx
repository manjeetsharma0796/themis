      ...
      <div className="mx-auto max-w-2xl px-4 py-10">
        ...
        {step === 0 && (
          <div className="space-y-5">
            <div>
              <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-brass">required · step 1 of 3</p>
        ...
        {step === 1 && (
          <div className="space-y-5">
            <div>
              <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-muted">optional · step 2 of 3</p>
